...
func GetNetworkSpecs(ctx context.Context, session *Session, devices object.VirtualDeviceList, desiredNetworks []string) ([]types.BaseVirtualDeviceConfigSpec, error) {
